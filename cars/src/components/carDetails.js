...
const CarDetails = () => {
  ...
  return (
    <>
    <div><input type="text" placeholder='search by bodytype'  onChange={handlechange}/></div>
    ...
    <div className='container'>
         
        {
            mycars.map((mycars)=>(
                ...
                <h3>{mycars.bodyType}</h3>
                <h4>{mycars.modelName} <span className='modeltype'>{mycars.modelType}</span></h4>
                <img src={mycars.imageUrl} alt="" /><br /><br />
                <span><a href="">LEARN ></a><a href="">SHOP ></a></span>
               </div>
            ))
        }
